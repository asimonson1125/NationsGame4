...
CHANGELOG = [
    {
        'version': '0.3.6-beta',
        'title': 'v0.3.6 Beta Release',
        'date': '2026-04-27',
        'body': (
            'Welcome to NationsEngine beta.  This version introduces factory demolishing.'
        ),
    },
    {
        'version': '0.3.5-beta',
    ...
    },
    {
        ...
        'date': '2026-03-24',
        'body': (
            'Welcome to NationsEngine beta.  This version reduces starvation '
            'rates, implements tax income reductions on population upkeep failure, '
            'and fixes display bugs.'
        ),
    },
    {
        'version': '0.3.3-beta',
        'title': 'v0.3.3 Beta Release',
        'date': '2026-03-20',
        'body': (
            'Welcome to NationsEngine beta.  This version introduces '
            'dramatically increased resource volumes from land exploration '
